...
<?php
	...
	if($op=="in"){
		...
		if(mysqli_num_rows($sql)==1){
			...
			if($qry['aktif']=="N"){
            echo "<div class='register-logo'><b>Oops!</b> User Active.</div>	
				<div class='register-box-body'>
					<p>Please wait a moment, or please contact your Admin email:<?php echo'<a href=\"mailto:$emailAdmin\">$emailAdmin</a>\'; ?></p>
					<div class='row'>
			...
			echo "<div class='register-logo'><b>Oops!</b> Login Failed.</div>	
				<div class='register-box-body'>
					<p>User or Password not match on Database. Please try again.</p>
					<div class='row'>
						<div class='col-xs-8'></div>
						<div class='col-xs-4'>
							<button type='button' onclick=location.href='index.php' class='btn btn-block btn-warning'>Back</button>
