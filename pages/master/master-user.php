<section class="content-header">
    <h1>Input<small>Data Users Akses</small></h1>
    <ol class="breadcrumb">
        <li><a href="home-admin.php"><i class="fa fa-dashboard"></i> Dashboard</a></li>
        <li class="active">Input Data User Akses</li>
    </ol>
</section>
...
<?php	
	...
	$cekuser	=mysqli_num_rows (mysqli_query($Open,"SELECT id_user FROM tb_user WHERE id_user='$_POST[id_user]'"));
	
		if (empty($_POST['id_user']) || empty($_POST['nama_user']) || empty($_POST['password']) || empty($_POST['hak_akses'])) {
		echo "<div class='register-logo'><b>Oops!</b> Incomplete Data.</div>
		...
		$insert = "INSERT INTO tb_user (id_user, nama_user, password, hak_akses, aktif) VALUES ('$id_user', '$nama_user', '$passmd5', '$hak_akses', 'Y')";
