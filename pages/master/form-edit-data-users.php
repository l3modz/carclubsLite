				...
				<form action="home-admin.php?page=edit-data-users&id_user=<?php echo $user?>" class="form-horizontal" method="POST" enctype="multipart/form-data">
					<div class="box-body">
						...
						<div class="form-group">
							...
							<div class="col-sm-7">
								<input type="text" name="password" class="form-control" value="" maxlength="225">Remember your password...
							</div>
						</div>
						
						<div class="form-group">
							<div class="col-sm-offset-3 col-sm-7">
								<button type="submit" name="edit" value="edit" class="btn btn-danger">Save</button> <?php echo "<button type='button' onclick=location.href='home-admin.php?page=form-master-user' class='btn btn-danger'>Back</button>"; ?>
							</div>
						</div>
					</div>
				</form>
