			...
			<div class="box box-primary">				
				...
				<div class="box-body">
					<table id="example1" class="table table-bordered table-striped">
						...
						while (null !== ($password = $tampilPassword->fetch_assoc()) || ($password0 = $tampilPassword0->fetch_assoc()) || ($password1 = $tampilPassword1->fetch_assoc()) || ($password2 = $tampilPassword2->fetch_assoc())) {
...
//$decrypted_txt = encrypt_decrypt('decrypt', $encrypted_txt);
						...
						?>	
							<tr>
								...
								<td><?php //echo encrypt_decrypt('decrypt', $password['kategori']);?></td>
								<td><?php //echo encrypt_decrypt('decrypt', $password['url']);?></td>
